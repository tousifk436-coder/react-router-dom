...
function Login() {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
      ...
      <form noValidate="" action="" className="space-y-6" onSubmit={submitHandler}>
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="w-full border-2 border-blue-500 px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-violet-600"
          />
        </div>
        <div className="space-y-1 text-sm">
