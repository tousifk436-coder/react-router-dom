  ...
  return (
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <form
          action="#"
          class="space-y-4 rounded-lg border border-2 py-2 px-4 border-gray-300 bg-gray-100 p-6"
        >
          <div>
            ...
            <input
              class="mt-1 w-full rounded-lg border-2 py-2 px-4 border-gray-300 focus:border-blue-500 focus:outline-none"
              id="name"
              type="text"
          ...
          <div>
            ...
            <textarea
              class="mt-1 w-full resize-none rounded-lg border-2 py-2 px-4 border-gray-300 focus:border-blue-500 focus:outline-none"
              id="message"
              rows="4"
          ...
          <button
            class="block w-full rounded-lg border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-blue-600"
            type="submit"
          >
            Send Message
          </button>
